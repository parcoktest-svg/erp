...
import ModuleLandingView from '@/views/modules/ModuleLandingView'

import CoreCompaniesView from '@/views/modules/core/CoreCompaniesView'
import CoreOrgsView from '@/views/modules/core/CoreOrgsView'
...
import ManufacturingReportsView from '@/views/modules/manufacturing/ReportsView'

import FinanceGlAccountsView from '@/views/modules/finance/GlAccountsView'
import FinancePeriodsView from '@/views/modules/finance/PeriodsView'
import FinanceReportsView from '@/views/modules/finance/ReportsView'
    ...
    <Routes>
      ...
      <Route element={<RequireAuth />}> 
        <Route element={<AppLayout />}>
          ...
          <Route path="/modules/:module" element={<ModuleLandingView />} />

          <Route path="/modules/core/companies" element={<CoreCompaniesView />} />
          <Route path="/modules/core/orgs" element={<CoreOrgsView />} />
          ...
          <Route path="/modules/finance/gl-accounts" element={<FinanceGlAccountsView />} />
