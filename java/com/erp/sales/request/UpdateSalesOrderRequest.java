...
public class UpdateSalesOrderRequest {
    ...
    @Valid
    private List<UpdateSalesOrderDeliveryScheduleRequest> deliverySchedules;
    ...
    public List<UpdateSalesOrderDeliveryScheduleRequest> getDeliverySchedules() {
        return deliverySchedules;
    }

    public void setDeliverySchedules(List<UpdateSalesOrderDeliveryScheduleRequest> deliverySchedules) {
    ...
    public static class UpdateSalesOrderDeliveryScheduleRequest {
        private LocalDate deliveryDate;
        private String shipMode;
        private String factory;
        private String remark;
